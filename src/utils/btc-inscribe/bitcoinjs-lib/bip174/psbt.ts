...
export class Psbt {
	...
	addInput(inputData: PsbtInputExtended): this {
		...
		addKeyVals.forEach((keyVal: KeyValue) => this.addUnknownKeyValToInput(inputIndex, keyVal));
	...
	addOutput(outputData: PsbtOutputExtended): this {
		...
		addKeyVals.forEach((keyVal: KeyValue) => this.addUnknownKeyValToInput(outputIndex, keyVal));
